...
- Factor out the common LDI logic. The only difference
...
def ldi_k_sep(
    ...
    """
    Compute the Linear Dependence Index (LDI) for a separable Hamiltonian
...
def ldi_k_imp(
    ...
    """
    Compute the Linear Dependence Index (LDI) for a general (possibly
